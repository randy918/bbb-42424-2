...
function init() {
    ...
    function showInfo(data, tabletop) {
        ...
        var disableWeb;
        var disableIndesign;
        var prefixWeb = "http://www.previewdocuments.com/tvc/assets/";
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            // write X-Title
             if (ifNew = "NEW") {
                 c(ifNew);
                 c(theTitle);
                 theNewTitle = theTitle.replace('NEW ', '<span id="green">NEW </span>');
                 theTitle = theNewTitle;
                 c(theTitle);
             }
           
            document.getElementById(`${currentCell}-Title`).innerHTML = theTitle;
            c("this is "); c(theTitle);
            ...
            document.getElementById(`${currentCell}-Image`).src = prefixWeb + prefix + "-" + suffix + "-image.jpg";
            document.getElementById(`${currentCell}-ImageDownload`).href = prefixWeb + prefix + "-" + suffix + "-email.pdf";

            if (imgTall == "n") {
                $(`#${currentCell}-Image`).css({
                    "width": "280",
                    "height": "auto"
                });
            }
            // email download
            document.getElementById(`${currentCell}-Pdf`).href = prefixWeb + prefix + "-" + suffix + "-email.pdf";
            //  printer download
            document.getElementById(`${currentCell}-Print`).href = prefixWeb + prefix + "-" + suffix + "-printer.pdf";
            //  indesign download
            document.getElementById(`${currentCell}-Indesign`).href = prefixWeb + prefix + "-" + suffix + "-indesign.zip";
            ...
            if (useIndesign == "n") {
                ...
                document.getElementById(`${currentCell}-Print`).href = prefixWeb + prefix + "-" + suffix + "-indesign.zip";
